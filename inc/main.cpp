...
int main ()
{
	...
	ft::map<int, int> m;
	ft::pair<int, int> p1(6, 111);
	ft::pair<int, int> p2(9, 222);
	ft::pair<int, int> p3(10, 333);
	ft::pair<int, int> p4(4, 444);
...
it = m.begin();
	...
	it++;
	std::cout << "key  " << it->first << " | value " << it->second << std::endl;
	//std::cout << "key  " << it->left->first << " | value " << it->left->second << std::endl;
	//std::cout << "key  " << it->right->first << " | value " << it->right->second << std::endl;
	//std::cout << "key  " << it->right->right->first << " | value " << it->right->right->second << std::endl;
